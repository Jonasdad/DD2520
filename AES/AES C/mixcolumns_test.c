...
void main(){
    char* test = "d4e0b81ebfb441275d52119830aef1e5";
    uint8_t byteArray[16];
    hexStringToBytes(test, byteArray, 16);
    print_array(byteArray);
    printf("Putting it into a 2D matrix\n");
    uint8_t (*matrix)[4] = block_to_matrix(byteArray);
